...
//    public static final String ADMIN_PASSWORD = "ADMIN_PASSWORD";
    ...
    public static final String createTablePostgres
            ...
            + " " + MarketSettings.SMTP_SERVER_URL + " text,"
            + " " + MarketSettings.SMTP_PORT + " text,"
            + " " + MarketSettings.SMTP_USERNAME + " text,"
            + " " + MarketSettings.SMTP_PASSWORD + " text,"

            + " " + MarketSettings.EMAIL_SENDER_NAME + " text,"
            + " " + MarketSettings.EMAIL_ADDRESS_FOR_SENDER + " text,"

            + " " + MarketSettings.COD_ENABLED + " boolean not null default 't',"
            + " " + MarketSettings.POD_ENABLED + " boolean not null default 't',"
            + " " + MarketSettings.RAZOR_PAY_ENABLED + " boolean not null default 'f',"
            + " " + MarketSettings.RAZOR_PAY_KEY_ID + " text,"
            + " " + MarketSettings.RAZOR_PAY_KEY_SECRET + " text,"

            + " " + MarketSettings.MSG_91_API_KEY + " text ,"
            + " " + MarketSettings.SENDER_ID_FOR_SMS + " text,"
            + " " + MarketSettings.SERVICE_NAME_FOR_SMS + " text,"

            + " " + MarketSettings.DEFAULT_COUNTRY_CODE + " int not null default 91,"
            + " " + MarketSettings.LOGIN_USING_OTP_ENABLED + " boolean not null default 'f',"

            + " " + MarketSettings.MARKET_FEE_PICKUP_FROM_SHOP + " FLOAT not null default 0,"
            + " " + MarketSettings.MARKET_FEE_HOME_DELIVERY + " FLOAT not null default 0,"
            + " " + MarketSettings.ADD_MARKET_FEE_TO_BILL + " boolean not null default 'f',"
            + " " + MarketSettings.USE_STANDARD_DELIVERY_FEE + " boolean not null default 'f',"
            + " " + MarketSettings.MARKET_DELIVERY_FEE_PER_ORDER + " FLOAT not null default 0,"

            + " " + MarketSettings.BOOTSTRAP_MODE_ENABLED + " boolean not null default 'f',"
            ...
            + " " + MarketSettings.JOINING_CREDIT_FOR_END_USER + " FLOAT not null default 0,"
            + " " + MarketSettings.JOINING_CREDIT_FOR_SHOP_OWNER + " FLOAT not null default 0,"

            + " " + MarketSettings.REFERRAL_CREDIT_FOR_END_USER_REGISTRATION + " FLOAT not null default 0,"
            + " " + MarketSettings.REFERRAL_CREDIT_FOR_SHOP_OWNER_REGISTRATION + " FLOAT not null default 0,"

            + " " + MarketSettings.UPDATED + " timestamp with time zone,"
            + " " + MarketSettings.CREATED + " timestamp with time zone NOT NULL DEFAULT now()"
