...
public class Shop {
	...
	public static final String ITEM_UPDATE_PERMITTED = "ITEM_UPDATE_PERMITTED";
	...
	public static final String createTableShopPostgres =
			...
			+ " " + Shop.ITEM_UPDATE_PERMITTED + " boolean default false,"
	...
	public static final String addColumnsMinOrder =
			" ALTER TABLE IF EXISTS " + Shop.TABLE_NAME
					...
					+ "  ADD COLUMN IF NOT EXISTS  " + Shop.ITEM_UPDATE_PERMITTED + "  boolean default false ";
