package org.nearbyshops.Model.ModelImages;
...
public class BannerImage {
    ...
    public static final String createTable = "CREATE TABLE IF NOT EXISTS "
            ...
            + " " + BannerImage.BANNER_IMAGE_ID + " SERIAL PRIMARY KEY,"
            + " " + BannerImage.SHOP_ID + " int,"
            + " " + BannerImage.IMAGE_FILENAME + " text,"

            + " " + BannerImage.TIMESTAMP_CREATED + " timestamp with time zone NOT NULL DEFAULT now(),"

            + " " + BannerImage.SORT_ORDER + " text,"
            + " " + BannerImage.SHOP_TO_OPEN + " int,"
            + " " + BannerImage.ITEM_TO_OPEN + " int,"

            + " " + BannerImage.SHOW_IN_FRONT_SCREEN + " boolean not null default 'f',"
            + " " + BannerImage.SHOW_IN_ITEMS_SCREEN + " boolean not null default 'f',"
            + " " + BannerImage.SHOW_IN_SHOP_HOME + " boolean not null default 'f',"

            + " FOREIGN KEY(" + BannerImage.SHOP_ID +") REFERENCES " + Shop.TABLE_NAME + "(" + Shop.SHOP_ID + ") ON DELETE SET NULL "
            + ")";
