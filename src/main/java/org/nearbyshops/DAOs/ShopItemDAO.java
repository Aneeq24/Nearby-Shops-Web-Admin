...
//		System.out.println("Query:" + updateStatement);
		...
		try {
			...
			// update only if item id and shop id both are valid and set
			if(shopItem.getItemID()>0 && shopItem.getShopID()>0)
			{
...
//  Boolean isOutOfStock, Boolean priceEqualsZero,
	...
	public ShopItemEndPoint getShopItemAvailability(
