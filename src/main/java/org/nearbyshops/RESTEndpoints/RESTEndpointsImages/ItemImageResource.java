...
public class ItemImageResource {
    ...
    @Autowired
    private ItemImagesDAO itemImagesDAO;
    ...
    public ResponseEntity<Object> createItemImage(@RequestBody ItemImage itemImage)
    {
    ...
    public ResponseEntity<Object> updateItemImage(@RequestBody ItemImage itemImage,
...
//            itemImage.setImageFilename(uploadImageNew(itemImage.getInputStream(),itemImage.getImageFilename()).getPath());
    ...
    @RolesAllowed({Constants.ROLE_ADMIN, Constants.ROLE_STAFF})
    public ResponseEntity<Object> deleteImage(@PathVariable("ImageID")int imageID)
    {
        ...
        if(rowCount >= 1)
        {
            if(itemImage.getImageFilename()!=null)
            {
    ...
    public ResponseEntity<Object> getItemImagesForEnduser(
            ...
            @RequestParam(value = "Offset",defaultValue = "0")int offset)
    {
        ...
        endPoint.setItemDetails(itemDAO.getItemPhoto(itemID));
...
//		}
    ...
    @GetMapping
    public ResponseEntity<Object> getItemImages(
            @RequestParam(value = "ItemID",required = false)Integer itemID,
            @RequestParam(value = "SortBy",required = false) String sortBy,
            @RequestParam(value = "Limit",required = false)Integer limit,
            @RequestParam(value = "Offset",defaultValue = "0")int offset)
...
//        System.out.println("Item ID : " + itemID + " Size : " + list.size());
...
//                System.out.println("DIR created");
    ...
    Image uploadImageNew(InputStream in, String previousImageName) throws Exception
    {
