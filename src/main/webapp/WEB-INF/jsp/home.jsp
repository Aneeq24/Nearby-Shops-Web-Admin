			...
			<div class="page-header-content pt-4">
				<div class="row align-items-center justify-content-between">
					<div class="col-auto mt-4">
						...
						<div class="page-header-subtitle">Example dashboard overview
							and content summary</div>
					</div>
					<div class="col-12 col-xl-auto mt-4">
						<button class="btn btn-white btn-sm line-height-normal p-3"
							id="reportrange">
							<i class="mr-2 text-primary" data-feather="calendar"></i> <span></span>
						...
						<div class="row align-items-center">
							<div class="col-xl-8 col-xxl-12">
								<div class="text-center px-4 mb-4 mb-xl-0 mb-xxl-4">
									...
									<p class="text-gray-700 mb-0">It's time to get started!
										View new opportunities now, or continue on your previous work.</p>
								</div>
							</div>
							<div class="col-xl-4 col-xxl-12 text-center">
								<img class="img-fluid" src="${assets}/img/freepik/at-work-pana.svg"
					...
					<div class="card-header">
						...
						<div class="dropdown no-caret">
							...
							<div
								...
								<a class="dropdown-item" href="#!"><span
									class="badge badge-blue-soft text-blue my-1">Reporting</span></a> <a
					...
					<div class="card-body">
						<div class="timeline timeline-xs">
							...
							<div class="timeline-item">
								...
								<div class="timeline-item-content">Server activity monitor
									alert</div>
							</div>
							<!-- Timeline Item 5-->
							<div class="timeline-item">
				...
				<div class="card card-header-actions h-100">
					...
					<a class="card-footer" href="#!">
						<div
							...
							Visit Task Center <i data-feather="arrow-right"></i>
						</div>
					</a>
				</div>
			</div>
